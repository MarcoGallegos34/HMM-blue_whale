...
NumericVector proposal_dist(const NumericVector theta_star, const int N = 3){
    ...
    NumericVector step_size_mu_duration = {.05,.05,.05};
    NumericVector step_size_sigma_duration = {.05,.05,.05};
    NumericVector step_size_mu_surface = {.05,.05,.05};
    NumericVector step_size_sigma_surface = {.05,.05,.05};
    NumericVector step_size_mu_maxDepth = {.05,.05,.05};
    NumericVector step_size_sigma_maxDepth = {.05,.05,.05};
    NumericVector step_size_mu_step = {.05,.05,.05};
    NumericVector step_size_sigma_step = {.05,.05,.05};
